		...
		<div class="col-md-8 col-lg-9">
			<div class="push-top-bottom">
				<div class="listing-detail">
					<div class="gallery">
    <div class="gallery-item" style="background-image: url('assets/img/oleh/brawijaya.jpg');"> 
        <div class="gallery-item-description">
            Hiasan lampu warna warni pada malam hari
            </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->            

    <div class="gallery-item" style="background-image: url('assets/img/oleh/jaya.jpg');">
        <div class="gallery-item-description">
            Quisque ornare efficitur risus eu bibendum
        </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/oleh/yaa.jpg');">
        <div class="gallery-item-description">
            Quisque ornare efficitur risus eu bibendum
        </div><!-- /.gallery-item-description -->  
    </div><!-- /.gallery-item -->                 
...
<h6 class="text-dark">
	  Toko oleh-oleh yang menyediakan oleh-oleh khas kota batu malang.
</h6>
</div>
</div>
</div>
