		...
		<div class="col-md-8 col-lg-9">
			<div class="push-top-bottom">
				<div class="listing-detail">
					<div class="gallery">
    <div class="gallery-item" style="background-image: url('assets/img/wisata/bromo1.jpg');"> 
        <div class="gallery-item-description">
            Hiasan lampu warna warni pada malam hari
            </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->            

    <div class="gallery-item" style="background-image: url('assets/img/wisata/bromo2.jpg');">
        <div class="gallery-item-description">
            Quisque ornare efficitur risus eu bibendum
        </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/wisata/bromo3.jpg');">
        <div class="gallery-item-description">
            Quisque ornare efficitur risus eu bibendum
        </div><!-- /.gallery-item-description -->  
    </div><!-- /.gallery-item -->                 
...
<h6 class="text-dark">
	   ...
	   Statusnya yang masih aktif membuat Gunung Bromo jadi lebih menarik di mata wisatawan. Ketinggian Gunung Bromo yaitu 2.392 meter diatas permukaan laut dan memiliki bentuk tubuh bertatutan dia antara lembah dan ngarai dengan dikelilingi kaldera atau lautan pasir luas kurang lebih sekitar 5.300 hektar.
	   Selain itu, terdapat objek wisata lain yang terdapat di Gunung Bromo antara lain Desa Ngadas, Bukit Teletubbis, Bukit Cinta, Bukit Kingkong Bromo, Danau Ranu Pani, Danau Ranu Kumbolo, dan masih banyak lagi.
</h6>
</div>
</div>
</div>
...
<div id="listing-position">
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.7773987160704!2d112.9502497140293!3d-8.021874694223326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd63f365f69c945%3A0x36aec022815992c9!2sTaman%20Nasional%20Bromo%20Tengger%20Semeru!5e0!3m2!1sid!2sid!4v1582201584667!5m2!1sid!2sid" width="800" height="400" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<ul class="comments">
	<li>
		<div class="comment">			
			<div class="comment-author">
				<a href="#" style="background-image: url('assets/img/tmp/profile-1.jpg');"></a>
			</div><!-- /.comment-author -->

			<div class="comment-content">			
				<div class="comment-meta">
					<div class="comment-meta-author">
						Diposting oleh <a href="#">Pengguna</a>
		...
		<ul>
			<li>
				<div class="comment">			
					<div class="comment-author">
						<a href="#" style="background-image: url('assets/img/tmp/profile-2.jpg');"></a>
					</div><!-- /.comment-author -->
	...
	<li>
		<div class="comment">			
			<div class="comment-author">
				<a href="#" style="background-image: url('assets/img/tmp/profile-3.jpg');"></a>
			</div><!-- /.comment-author -->
...
<div class="comment-create clearfix">
    ...
    <div class="overview">        
        <ul>
            ...
            <li><strong>Lokasi</strong><span>Bromo Tengger Semeru Nasional Park.East Java.indonesia</span></li>
            <li><strong>Jenis</strong><span>Taman Nasional</span></li>
            <li><strong>Rating</strong><span>4,8 by 34.977 review
</span></li>
            <li><strong>Telepone</strong><span>(0341) 491828</span></li>
            <li><strong>Alamat Web</strong><span><a href="https://bromotenggersemeru.org/">bromotenggersemeru.org</a></span></li>                    
        </ul>
    </div><!-- /.overview -->
</div><!-- /.widget -->
				
				<div class="widget">
	<h2 class="widgettitle">Kontak Informsi</h2>
	...
	<ul class="contact">
		...
		<li><i class="md-icon">phone</i>(0341) 491828</li>
		<li><i class="md-icon">location_on</i>Bromo Tengger Semeru Nasional Park.East Java.indonesia</li>
	</ul>
</div><!-- /.widget -->
