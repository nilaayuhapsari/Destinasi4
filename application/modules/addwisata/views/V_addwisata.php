				...
				<div class="row">
					<div class="col-md-8 col-lg-7">
						<div class="content">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="card">
										...
										<div class="card-content">
											<h3><a href="listing-detail4.html">Wisata</a></h3>
											<h2><a href="listing-detail4.html">Bukit Kuneer Singosari</a></h2>
										</div><!-- /.card-content -->
										<div class="container">
											<div id="demo-state-btn" type="button" data-target="#1" data-toggle="modal" class="btn btn-primary btn-block" data-loading-text="Loading...">tambah</div>
										</div>
							...
							<div class="col-sm-5">
								<div class="card">
									<center><a href="adding.html">
											<div type="button" class="btn btn-primary btn-block">Kembali ke daftar tambah</div>
									</center></a>
								</div><!-- /.push-top-bottom -->
							</div>
						</div>
				...
				<div class="col-lg-5">
					<div class="sidebar">
						<div class="admin-box no-padding">
							<div class="widget">
								<center>
									<h2 class="widgettitle">Daftar Destinasi Anda</h2>
								</center>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="listings-map.html"><button type="button" class="btn btn-primary">Iya</button></a>
			</div>
		</div>
	</div>
</div>
