		...
		<div class="col-md-8 col-lg-9">
			<div class="push-top-bottom">
				<div class="listing-detail">
					<div class="gallery">
    <div class="gallery-item" style="background-image: url('assets/img/wisata/s5.jpg');"> 
        <div class="gallery-item-description">
            Hiasan lampu warna warni pada malam hari
            </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->            

    <div class="gallery-item" style="background-image: url('assets/img/wisata/s2.jpg');">
        <div class="gallery-item-description">
        </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/wisata/s4.jpg');">
        <div class="gallery-item-description">
        </div><!-- /.gallery-item-description -->  
    </div><!-- /.gallery-item -->                 
</div><!-- /.gallery -->
...
<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/s1.jpg" height="150" width="150">
					<img src="assets/img/wisata/s2.jpg" height="150" width="150">
					<img src="assets/img/wisata/s3.jpg" height="150" width="150">
					<img src="assets/img/wisata/s4.jpg" height="150" width="150">
					<img src="assets/img/wisata/s5.jpg" height="150" width="150">
					</div>
				</div>
			</div>
			<br/>
	...
	<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/s5.jpg" height="150" width="150">
					<img src="assets/img/wisata/s6.jpg" height="150" width="150">
					<img src="assets/img/wisata/s7.jpg" height="150" width="150">
					<img src="assets/img/wisata/s8.jpg" height="150" width="150">
					<img src="assets/img/wisata/s9.jpg" height="150" width="150">
					</div>
				</div>
			</div>
			<br/>
            ...
            <tr>
                <th>Buka setiap hari 24 jam</th>
					...
					<div id="listing-position">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2022292.182470446!2d111.49999153124996!3d-8.122910599999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd6207d89138a3f%3A0x8c4952436696f6ff!2sSumber%20Sira%20Putukrejo!5e0!3m2!1sid!2sid!4v1582434014635!5m2!1sid!2sid" width="810" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<div class="comment-create clearfix">
    ...
    <div class="overview">        
        <ul>
            <li><strong>Harga</strong><span>Rp.1000,-</span></li>
            <li><strong>Lokasi</strong><span>Jalan Sunan Kalijaga I RT.05/RW.02, Putuk Utara, Putukrejo, Kec. Gondanglegi, Malang, Jawa Timur 65174</span></li>
			<li><strong>Kategory</strong><span>Wisata</span></li>
			<li><strong>Ratings</strong><h6><span>4.3 by 1,989 reviews</span></li>
            <li><strong>No Telp</strong><span>0856-0890-3100</span></li>
            <li><strong>Website</strong><span><a href="business.site">business.site</a></span></li>                    
        </ul>
    </div><!-- /.overview -->
</div><!-- /.widget -->
	...
	<ul class="contact">
		<li><i class="md-icon">email</i> <a href="business.site">business.site</a></li>
		<li><i class="md-icon">link</i> <a href="#">example.com</a></li>
		<li><i class="md-icon">phone</i>0856-0890-3100</li>
		<li><i class="md-icon">location_on</i> Jalan Sunan Kalijaga I RT.05/RW.02, Putuk Utara, Putukrejo, Kec. Gondanglegi, Malang, Jawa Timur 65174</li>
	</ul>
</div><!-- /.widget -->
