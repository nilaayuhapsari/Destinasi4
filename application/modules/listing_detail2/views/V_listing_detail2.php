		...
		<div class="col-md-8 col-lg-9">
			<div class="push-top-bottom">
				<div class="listing-detail">
					<div class="gallery">
    <div class="gallery-item" style="background-image: url('assets/img/wisata/2.jpg');"> 
        <div class="gallery-item-description">
            Hiasan lampu warna warni pada malam hari
            </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->            

    <div class="gallery-item" style="background-image: url('assets/img/wisata/h.jpg');">
        <div class="gallery-item-description">
        </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/wisata/f.jpg');">
        <div class="gallery-item-description">
        </div><!-- /.gallery-item-description -->  
    </div><!-- /.gallery-item -->                 
</div><!-- /.gallery -->
...
<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/e.jpg" height="150" width="150">
					<img src="assets/img/wisata/f.jpg" height="150" width="150">
					<img src="assets/img/wisata/g.jpg" height="150" width="150">
					<img src="assets/img/wisata/h.jpg" height="150" width="150">
					<img src="assets/img/wisata/i.jpg" height="150" width="150">
					</div>
				</div>
			</div>
			<br/>
	...
	<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/j.jpg" height="150" width="150">
					<img src="assets/img/wisata/k.jpg" height="150" width="150">
					<img src="assets/img/wisata/l.jpg" height="150" width="150">
					<img src="assets/img/wisata/m.jpg" height="150" width="150">
					<img src="assets/img/wisata/n.jpg" height="150" width="150">
            ...
            <tr>
                <th>Buka setiap hari 24 jam</th>
					...
					<div id="listing-position">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.7306648183508!2d112.65501931432786!3d-7.923175681076868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd629866466afe7%3A0x41e4435bb9bc1c00!2sMalang%20Night%20Paradise!5e0!3m2!1sid!2sid!4v1582120424629!5m2!1sid!2sid" width="810" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<div class="comment-create clearfix">
    ...
    <div class="overview">        
        <ul>
				<li><strong>Harga</strong><span>
						-Tiket Reguler Senin - Kamis</br> Rp50.000
						<br/>
						<br/>
						-Tiket Reguler Jum'at - Minggu </br> Rp65.000
						<br/>
						<br/>
						-Tiket Terusan Senin-Kamis </br> Rp75.000
						<br/>
						<br/>
						-Tiket Terusan Jumat-Minggu </br> Rp100.000
					</span></li>
            <li><strong>Lokasi</strong><span>Jl. Graha Kencana Raya Jl. Raya Karanglo No.66, Karanglo, Balearjosari, Kec. Blimbing, Malang, Jawa Timur 65126</span></li>
			<li><strong>Kategory</strong><span>Wahana Hiburan</span></li>
			<li><strong>Ratings</strong><h6><span>4.4 by 8,633 reviews</span></li>
            <li><strong>No Telp</strong><span>(0341) 4351795</span></li>
            <li><strong>Website</strong><span><a href="malangnightparadise.com"></a>malangnightparadise.com</span></li>                    
        </ul>
    </div><!-- /.overview -->
</div><!-- /.widget -->
	...
	<ul class="contact">
		<li><i class="md-icon">email</i> <a href="malangnightparadise.com">malangnightparadise.com</a></li>
		<li><i class="md-icon">link</i> <a href="#">malangnightparadise.com</a></li>
		<li><i class="md-icon">phone</i>(0341) 4351795</li>
		<li><i class="md-icon">location_on</i> Jl. Graha Kencana Raya Jl. Raya Karanglo No.66, Karanglo, Balearjosari, Kec. Blimbing, Malang, Jawa Timur 65126</li>
	</ul>
</div><!-- /.widget -->
