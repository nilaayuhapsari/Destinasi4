		...
		<div class="col-md-8 col-lg-9">
			<div class="push-top-bottom">
				<div class="listing-detail">
					<div class="gallery">
    <div class="gallery-item" style="background-image: url('assets/img/wisata/4.jpg');"> 
        <div class="gallery-item-description">
            </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->            

    <div class="gallery-item" style="background-image: url('assets/img/wisata/10.jpg');">
        <div class="gallery-item-description">
        </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/wisata/11.jpg');">
        <div class="gallery-item-description">
        </div><!-- /.gallery-item-description -->  
    </div><!-- /.gallery-item -->                 
</div><!-- /.gallery -->
...
<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/10.jpg" height="150" width="150">
					<img src="assets/img/wisata/11.jpg" height="150" width="150">
					<img src="assets/img/wisata/12.jpg" height="150" width="150">
					<img src="assets/img/wisata/13.jpg" height="150" width="150">
					<img src="assets/img/wisata/14.jpg" height="150" width="150">
					</div>
				</div>
			</div>
			<br/>
	...
	<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/16.jpg" height="150" width="150">
					<img src="assets/img/wisata/17.jpg" height="150" width="150">
					<img src="assets/img/wisata/18.jpg" height="150" width="150">
					<img src="assets/img/wisata/19.jpg" height="150" width="150">
					<img src="assets/img/wisata/20.jpg" height="150" width="150">
					</div>
				</div>
			</div>
			<br/>
            ...
            <tr>
                <th>Buka setiap hari 24 jam</th>
					...
					<div id="listing-position">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.78319609832!2d112.62980451432662!3d-7.812760079739265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7d56f5ee3b94d%3A0xbdd44aa185913552!2sBukit%20Kuneer!5e0!3m2!1sid!2sid!4v1582433593565!5m2!1sid!2sid" width="810" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<div class="comment-create clearfix">
    ...
    <div class="overview">        
        <ul>
            <li><strong>Harga</strong><span>Weekday Rp.8.000
				<div></div>
				Weekend Rp.12.000
			</span></li>
            <li><strong>Lokasi</strong><span>Jalan lereng Arjuno No.65153, Kreweh, Gunungrejo, Kec. Singosari, Malang, Jawa Timur 65153</span></li>
			<li><strong>Kategory</strong><span>Wisata</span></li>
			<li><strong>Ratings</strong><h6><span>4.4 by 9,22 reviews</span></li>
	...
	<ul class="contact">
		...
		<li><i class="md-icon">location_on</i>  Jalan lereng Arjuno No.65153, Kreweh, Gunungrejo, Kec. Singosari, Malang, Jawa Timur 65153</li>
	</ul>
</div><!-- /.widget -->
