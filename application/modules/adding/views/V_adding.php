            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <center>
                                <h2>Pilih Apa Yang ingin Anda Tambahkan</h2>
                            </center>
                        ...
                        <div class="container">
                            <div class="page-title">
                                ...
                                <a href="listings.html">
                                    <div class="btn btn-primary" type="button">Kembali</div>
                                </a>
                            </div><!-- /.page-title -->
                        </div>
                        <!--container-->
                    ...
                    <div class="col-lg-5">
                        <div class="sidebar">
                            <div class="admin-box no-padding">
                                ...
                                <div class="container">
                                    <center><a href="jadwal.html">
                                            <div class="btn btn-success" type="button">Atur Jadwal</div>
                                        </a></center>
                                    </br>
                                </div>
                            </div>
