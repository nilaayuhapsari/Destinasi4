        ...
        <div class="admin-sidebar">
            ...
            <div class="dashboard-nav-primary collapse navbar-toggleable-md">
                <ul class="nav nav-pills nav-stacked">
                    <li class="nav-item">
                        <a href="admin_dashboard" class="nav-link active"><i class="md-icon">home</i> Halaman admin</a>
                    </li>

                    <li class="nav-item">
                        <a href="admin_kategori" class="nav-link"><i class="md-icon">view_list</i> List Kategori <span>9</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="admin_listings" class="nav-link"><i class="md-icon">view_list</i> List Ajuan <span>3</span></a>
					</li>
					
					<li class="nav-item">
						<a href="data" class="nav-link"><i class="md-icon">view_list</i> Data Kategori <span>3</span></a>
					</li>

                    <li class="nav-item">
                        <a href="admin_reviews" class="nav-link "><i class="md-icon">rate_review</i> Komentar</a>
                    </li>

                    <li class="nav-item">
                        <a href="admin_users" class="nav-link "><i class="md-icon">people</i> Pengguna <span>1</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="admin_settings" class="nav-link "><i class="md-icon">settings</i> Pengaturan</a>
                    </li>

                    <li class="nav-item">
                        <a href="index" class="nav-link"><i class="md-icon">power_settings_new</i> Keluar</a>
                    </li>
                </ul>
            </div>
