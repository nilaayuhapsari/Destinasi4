		...
		<div class="col-md-8 col-lg-9">
			<div class="push-top-bottom">
				<div class="listing-detail">
					<div class="gallery">
    <div class="gallery-item" style="background-image: url('assets/img/wisata/1.jpg');"> 
        <div class="gallery-item-description">
            Hiasan lampu warna warni pada malam hari
            </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->            

    <div class="gallery-item" style="background-image: url('assets/img/wisata/ww.jpg');">
        <div class="gallery-item-description">
            Quisque ornare efficitur risus eu bibendum
        </div><!-- /.gallery-item-description -->
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/wisata/b.jpg');">
        <div class="gallery-item-description">
            Quisque ornare efficitur risus eu bibendum
        </div><!-- /.gallery-item-description -->  
    </div><!-- /.gallery-item -->                 
...
<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/dalam1.jpg" height="150" width="150">
					<img src="assets/img/wisata/dalam2.jpg" height="150" width="150">
					<img src="assets/img/wisata/dalam3.jpg" height="150" width="150">
					<img src="assets/img/wisata/a.jpg" height="150" width="150">
					<img src="assets/img/wisata/b.jpg" height="150" width="150">
	...
	<div class="row">
		<div class="col-sm-1 col-xl-12">
				...
				<div class="row">
					<img src="assets/img/wisata/luar1.jpg" height="150" width="150">
					<img src="assets/img/wisata/luar2.jpg" height="150" width="150">
					<img src="assets/img/wisata/luar3.jpg" height="150" width="150">
					<img src="assets/img/wisata/c.jpg" height="150" width="150">
					<img src="assets/img/wisata/d.jpg" height="150" width="150">
...
<div id="listing-position" >
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d252944.40334161796!2d112.45376076891898!3d-7.8682262536254735!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78872ad61d07b9%3A0x59a848ad52479780!2sJawa%20Timur%20Park%201!5e0!3m2!1sid!2sid!4v1582385336482!5m2!1sid!2sid" width="800" height="400" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<div class="comment-create clearfix">
    ...
    <div class="overview">        
        <ul>
            <li><strong>Harga</strong><span>
				-Tiket Reguler</br> Rp75.000
				<br/>
				<br/>
				-Tiket paket 1 (jatim park 1+museum tubuh) </br> Rp91.000-Rp120.000
				<br/>
				<br/>
				-Tiket sakti (berlaku 2 hari) </br> Rp375.000
				<br/>
				<br/>
				-Tiket super sakti (berlaku 3 hari) </br> Rp450.000
			</span></li>
            <li><strong>Lokasi</strong><span>Jl. Dewi Sartika Atas, Sisir, Kec. Batu, Kota Batu, Jawa Timur</span></li>
			<li><strong>Kategory</strong><span>Taman Hiburan</span></li>
			<li><strong>Ratings</strong><h6><span>4.29 by 29 reviews</span></li>
	...
	<ul class="contact">
		...
		<li><i class="md-icon">phone</i>(0274) 540790</li>
		<li><i class="md-icon">location_on</i> Jl. Dewi Sartika Atas, Sisir, Kec. Batu, Kota Batu, Jawa Timur</li>
	</ul>
</div><!-- /.widget -->
